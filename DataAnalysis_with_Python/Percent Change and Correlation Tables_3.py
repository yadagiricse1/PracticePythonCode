...
HPL_State_Correlation=HPI_data2.corr()

print(HPL_State_Correlation)   

print(HPL_State_Correlation.describe()) # descirbe will give descriptive stats data like std,mean,min,max 
