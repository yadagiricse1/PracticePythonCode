...
x,y=m(lon,lat)
m.plot(x,y,'ro',markersize=10,alpha=0.5)

lat,lon=42.6875,-83.2341 # detroit
x,y=m(lon,lat)
m.plot(x,y,'go',markersize=10,alpha=0.5)
#alpha =0.5 shows the overlaping feature . Please execte and check how it shows


at,lon=41.8781,-87.6298
xpt,ypt = m(lon,lat)
m.plot(xpt,ypt, 'go',markersize=10,alpha=0.5) #chicago
