...
def graph_data(stock):
    ...
    bbox_props = dict(boxstyle='larrow',fc='w', ec='k',lw=1)  #boxstyle='round' or round4
    
    ax1.annotate(str(closep[2]), (date[2], closep[2]),
                 xytext = (date[2]+4, closep[2]),bbox=bbox_props)
    '''
    ...
    plt.title(stock)
    plt.legend()
    plt.subplots_adjust(left=0.09,right=0.85,bottom=0.18,top=0.95,wspace=0.2,hspace=0) # this is used to set proper borders and spacing
    plt.show()
